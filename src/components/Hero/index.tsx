  ...
  <section className="py-16 @container sm:py-24">
    <div className="flex flex-col gap-6 px-4 @[864px]:flex-row-reverse @[864px]:items-center">
      <div className="mx-auto w-full max-w-sm flex-shrink-0 @[864px]:w-1/3">
        <img className="aspect-square w-full rounded-full object-cover object-top shadow-lg" alt="Professional headshot of a software engineer" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBQ_zguidyuOg4itWx-XmzK2l04H0VJA4U0xRYSMehysetqB25t6qaLMmYpK1iz3luhLoQTRXLm9VXiCORivMnqHp-rz9Vn_RcDkxgY6rP4n2I_UI8yY2BUaYVe57V4nrjs5qZdjM9fuCPAXMjAf0QlOjimADG4OPU4qAIqIf3YEmPu9yojRNbJAKgLn9NHsGtbo5EtIlXMbHLfv686zPi9vBqx81yu5cfCeSbCOcU07AWNT1YY_Q034DGUqFjfYcYREE-p2dgOEbA"/>
      </div>
      <div className="flex flex-col gap-6 text-center @[480px]:min-w-[400px] @[480px]:gap-8 @[864px]:text-left">
        <div className="flex flex-col gap-2">
          <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl">John Doe, Full-Stack Software Engineer</h1>
